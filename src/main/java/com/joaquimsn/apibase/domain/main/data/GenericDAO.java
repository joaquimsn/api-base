package com.joaquimsn.apibase.domain.main.data;
...
public abstract class GenericDAO<T> implements Serializable {
	...
	public T update(final T entity) {
		try {
			...
			throw TypeApplicationException.PERSISTENCIA.buildException("Ocorreu uma falha na atualização");
		}
	...
	public void delete(final Serializable id) {
		try {
			...
			throw TypeApplicationException.PERSISTENCIA.buildException("Ocorreu uma falha na remoção");
		}
	}
	...
	public Optional<T> findById(final Serializable id) {
		try {
			...
			throw TypeApplicationException.PERSISTENCIA.buildException("Ocorreu uma falha consulta");
		}
	}
	...
	public List<T> findAll() {
		...
		try {
			...
			throw TypeApplicationException.PERSISTENCIA.buildException("Ocorreu uma falha na consulta");
		}
	}
}